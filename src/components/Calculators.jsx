        ...
        {/* <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {calculators.map((c) => (
            <button 
              ...
              className="flex items-center gap-4 p-4 rounded-xl bg-gradient-to-br from-blue-600 to-blue-700 text-white hover:shadow-xl hover:-translate-y-1 transition-all shadow-md text-left group"
            >
  ...
  {calculators.map((c) => (
    <button 
      ...
      className="flex items-center gap-4 p-4 rounded-2xl
                 bg-gradient-to-br from-indigo-800 via-cyan-600 to-blue-500
                 text-white hover:shadow-2xl hover:-translate-y-1 transition-all shadow-lg text-left group"
    >
